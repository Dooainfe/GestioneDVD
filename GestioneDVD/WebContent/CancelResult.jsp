...
<% 
	...
	String sql2= "DELETE FROM film WHERE film.IDfilm = "+id;
	String sql3= "DELETE FROM tfilm_attori WHERE tfilm_attori.IDfilm = "+id;
	String sql4= "DELETE FROM tfilm_generi WHERE tfilm_generi.IDfilm = "+id;		
...
<title>Record Eliminato - <%=res.getString("Titolo") %></title>
</head>
<body>
<% 

//Elimina dalla tabella film
stmt.executeUpdate(sql2);

//Elimina dalla tabella film_attori
stmt.executeUpdate(sql3);

//Elimina dalla tabella film_generi
...
<div class=esito>Film cancellato, spero non ti pentirai!</div>
